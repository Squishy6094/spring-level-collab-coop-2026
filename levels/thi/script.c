...
const LevelScript level_thi_entry[] = {
	...
	AREA(1, thi_area_1),
		...
		OBJECT(E_MODEL_NONE, 2954, -484, 857, 0, 0, 0, (0x94 << 16), id_bhvWarp),
		...
		OBJECT(E_MODEL_YELLOW_COIN, 6551, -393, -1286, 0, 0, 0, (1 << 16), id_bhvYellowCoin),
		OBJECT(E_MODEL_YELLOW_COIN, 6378, -393, -992, 0, 0, 0, (1 << 16), id_bhvYellowCoin),
