...
const LevelScript level_thi_entry[] = {
	...
	AREA(2, thi_area_2),
		...
		MARIO_POS(0x02, 0, -410, 1839, -1668),
	...
	AREA(3, thi_area_3),
		...
		MARIO_POS(0x03, 0, 230, 7410, -351),
		OBJECT(MODEL_NONE, 230, 7410, -351, 0, 90, 0, (0x97 << 16), bhvSpinAirborneWarp),
