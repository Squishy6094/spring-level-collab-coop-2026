...
const LevelScript level_rr_entry[] = {
	...
	AREA(1, rr_area_1),
		...
		OBJECT(E_MODEL_BREAKABLE_BOX, -1399, 2139, 3524, 0, 0, 0, 0x00000000, id_bhvBreakableBox),
		...
		OBJECT(E_MODEL_YELLOW_COIN, -3901, 2231, 6161, 0, -180, 0, 0x00020000, id_bhvOneCoin),
		OBJECT(E_MODEL_YELLOW_COIN, -3750, 2231, 6161, 0, -180, 0, 0x00020000, id_bhvOneCoin),
		OBJECT(E_MODEL_YELLOW_COIN, -3601, 2231, 6161, 0, -180, 0, 0x00020000, id_bhvOneCoin),
		OBJECT(E_MODEL_YELLOW_COIN, -9931, 2150, 5996, 0, -180, 0, 0x00020000, id_bhvOneCoin),
		OBJECT(E_MODEL_YELLOW_COIN, -10064, 2150, 5996, 0, -180, 0, 0x00020000, id_bhvOneCoin),
		OBJECT(E_MODEL_YELLOW_COIN, -9780, 2150, 5996, 0, -180, 0, 0x00020000, id_bhvOneCoin),
		OBJECT(E_MODEL_YELLOW_COIN, -9632, 2150, 5996, 0, -180, 0, 0x00020000, id_bhvOneCoin),
		OBJECT(E_MODEL_YELLOW_COIN, -10742, 3317, 5692, 0, -180, 0, 0x00020000, id_bhvOneCoin),
		OBJECT(E_MODEL_YELLOW_COIN, -10875, 3317, 5692, 0, -180, 0, 0x00020000, id_bhvOneCoin),
		OBJECT(E_MODEL_YELLOW_COIN, -10592, 3317, 5692, 0, -180, 0, 0x00020000, id_bhvOneCoin),
		OBJECT(E_MODEL_YELLOW_COIN, -10443, 3317, 5692, 0, -180, 0, 0x00020000, id_bhvOneCoin),
		...
		OBJECT(E_MODEL_RED_COIN, -1399, 2139, 3524, 0, 0, 0, 0x00000000, id_bhvRedCoin),
