...
const LevelScript level_rr_entry[] = {
	...
	AREA(1, rr_area_1),
		...
		WARP_NODE(0x03, LEVEL_RR, 0x01, 0x04, WARP_NO_CHECKPOINT),
		WARP_NODE(0x04, LEVEL_RR, 0x01, 0x03, WARP_NO_CHECKPOINT),
		...
		OBJECT(MODEL_NONE, -5929, 1014, -7056, 0, 0, 0, 0x00030000, id_bhvWarp),
		OBJECT(MODEL_NONE, 5775, 1612, -8191, 0, -45, 0, 0x00040000, id_bhvWarp),
