...
const GeoLayout ddd_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, ddd_dl_Constellation_Tiles_001_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, ddd_dl_Constellation_Tiles_002_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, ddd_dl_Asteroid_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 0, 554, 0, ddd_dl_Asteroid_001_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -26495, 3485, -22165, 0, 0, 29, ddd_dl_Asteroid_002_mesh_layer_1),
