...
const LevelScript level_ddd_entry[] = {
	...
	AREA(1, ddd_area_1),
		...
		OBJECT(E_MODEL_BRIGADE_BLUE, 1770, 273, -27748, 0, -159, 0, (DIALOG_120 << 24), bhvToadMessage),
		...
		OBJECT(E_MODEL_BRIGADE_YELLOW, 1487, 258, -27815, 0, 163, 0, (DIALOG_122 << 24), bhvToadMessage),
