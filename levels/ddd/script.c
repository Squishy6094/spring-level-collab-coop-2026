...
const LevelScript level_ddd_entry[] = {
	...
	AREA(1, ddd_area_1),
		...
		OBJECT(E_MODEL_BRIGADE_BLUE, 733, 442, -721, 0, 0, 0, (DIALOG_120 << 24), bhvToadMessage),
		...
		OBJECT(E_MODEL_BRIGADE_YELLOW, 538, 445, -720, 0, 0, 0, (DIALOG_122 << 24), bhvToadMessage),
