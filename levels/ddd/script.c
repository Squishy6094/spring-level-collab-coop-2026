...
const LevelScript level_ddd_entry[] = {
	...
	AREA(1, ddd_area_1),
		...
		OBJECT(E_MODEL_QUESTION_COIN, -1211, 685, 671, 0, 0, 0, 0x00000000, bhvQuestionCoin),
		OBJECT(E_MODEL_GAS_GIANT, 17322, 3060, 15919, 0, 0, 0, 0x00000000, bhvGasGiant),
		MARIO_POS(0x01, 0, 0, 684, 0),
		OBJECT(E_MODEL_RAINBOW_NOTE, -575, 685, 665, 0, 0, 0, 0x00000000, bhvRainbowNote),
		OBJECT(E_MODEL_RAINBOW_NOTE, -350, 685, 665, 0, 0, 0, 0x00000000, bhvRainbowNote),
		OBJECT(E_MODEL_RAINBOW_NOTE, -118, 685, 665, 0, 0, 0, 0x00000000, bhvRainbowNote),
		OBJECT(E_MODEL_RAINBOW_NOTE, -838, 685, 665, 0, 0, 0, 0x00000000, bhvRainbowNote),
		OBJECT(E_MODEL_RAINBOW_NOTE, 82, 685, 665, 0, 0, 0, 0x00000000, bhvRainbowNote),
		OBJECT(E_MODEL_RAINBOW_NOTE, 295, 685, 665, 0, 0, 0, 0x00000000, bhvRainbowNote),
		OBJECT(E_MODEL_RAINBOW_NOTE, 490, 685, 665, 0, 0, 0, 0x00000000, bhvRainbowNote),
		OBJECT(E_MODEL_RAINBOW_NOTE, 685, 685, 665, 0, 0, 0, 0x00000000, bhvRainbowNote),
		OBJECT(E_MODEL_RAINBOW_NOTE, 881, 685, 665, 0, 0, 0, 0x00000000, bhvRainbowNote),
		OBJECT(E_MODEL_RAINBOW_NOTE, 1059, 685, 665, 0, 0, 0, 0x00000000, bhvRainbowNote),
		OBJECT(E_MODEL_RAINBOW_NOTE, 1231, 685, 665, 0, 0, 0, 0x00000000, bhvRainbowNote),
		OBJECT(E_MODEL_RAINBOW_NOTE, 1398, 685, 665, 0, 0, 0, 0x00000000, bhvRainbowNote),
		...
		OBJECT(E_MODEL_BRIGADE_BLUE, 1770, -287, -27748, 0, -159, 0, (DIALOG_120 << 24), bhvToadMessage),
		OBJECT(MODEL_STAR, -26499, 4453, -22118, 0, 0, 0, (1 << 24) | (1 << 16) | (1 << 8), bhvStar),
		OBJECT(MODEL_NONE, 993, 643, 59, 0, 0, 0, (4 << 24) | (4 << 16) | (4 << 8), bhvRainbowNote_StarSpawn),
		...
		OBJECT(E_MODEL_BRIGADE_YELLOW, 1487, -302, -27815, 0, 163, 0, (DIALOG_122 << 24), bhvToadMessage),
