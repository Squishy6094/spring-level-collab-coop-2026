...
const LevelScript level_lll_entry[] = {
	...
	AREA(2, lll_area_2),
		...
		OBJECT(E_MODEL_BLARGG, -873, -252, 3097, 0, -25, 0, 0x00000000, bhvBlargg),
		OBJECT(E_MODEL_BLARGG, -440, -252, 3643, 0, 44, 0, 0x00000000, bhvBlargg),
		...
		OBJECT(E_MODEL_RISING_LAVA_PLATFORM, 9, -298, 2378, 0, 0, 0, (0x02 << 16), id_bhvRisingLavaPlatform),
