...
const LevelScript level_lll_entry[] = {
	...
	AREA(1, lll_area_1),
		...
		WARP_NODE(0x92, LEVEL_LLL, 0x02, 0x93, WARP_NO_CHECKPOINT),
		MARIO_POS(0x01, 65, -2184, 732, -2234),
		OBJECT(MODEL_NONE, 720, -27, -2558, 0, -61, 0, (0x92 << 16), bhvWarp),
		OBJECT(MODEL_NONE, 627, -27, -2726, 0, -61, 0, (0x92 << 16), bhvWarp),
		OBJECT(MODEL_NONE, 2050, 1761, 1564, 0, -45, 0, (0x90 << 16), bhvWarp),
		OBJECT(MODEL_NONE, 2050, 1552, 1564, 0, -45, 0, (0x90 << 16), bhvWarp),
	...
	AREA(2, lll_area_2),
		...
		WARP_NODE(0x93, LEVEL_LLL, 0x01, 0x93, WARP_NO_CHECKPOINT),
		OBJECT(E_MODEL_CAPTAIN_TOAD, -353, 0, 19, 0, 0, 0, 0x00000000, bhvToadMessage),
		...
		OBJECT(MODEL_NONE, 0, 1512, 0, 0, 0, 0, (0x91 << 16), bhvSpinAirborneWarp),
