...
const LevelScript level_lll_entry[] = {
	...
	AREA(2, lll_area_2),
		...
		OBJECT(E_MODEL_BLARGG, -14, -252, 3097, 0, 0, 0, 0x00000000, bhvBlargg),
		OBJECT(E_MODEL_BLARGG, -48, -155, -1600, 0, 0, 0, 0x00000000, bhvBlargg),
		OBJECT(E_MODEL_CAPTAIN_TOAD, 305, 0, 19, 0, 0, 0, (DIALOG_082 << 24), bhvToadMessage),
		OBJECT(E_MODEL_GREEN_TOAD, -225, 0, 250, 0, 135, 0, (DIALOG_016 << 24), bhvToadMessage),
		...
		OBJECT(MODEL_NONE, 72, 355, 938, 0, 0, 0, (0x02 << 24), bhvHiddenRedCoinStar),
		...
		OBJECT(E_MODEL_RISING_LAVA_PLATFORM, 9, -305, 2378, 0, 0, 0, (0x02 << 16), id_bhvRisingLavaPlatform),
		OBJECT(MODEL_STAR, 1, 100, 5308, 0, 0, 0, (0x05 << 24), bhvStar),
		OBJECT(MODEL_NONE, 0, 800, 5677, 0, 180, 0, (0x93 << 16), bhvSpinAirborneWarp),
		OBJECT(E_MODEL_RISING_LAVA_PLATFORM, -930, 1370, 5025, -90, 0, 0, (0x02 << 16) | (0x03 << 8), id_bhvShiftingLavaPlatform),
