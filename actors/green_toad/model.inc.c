...
// 0x06005908
static const Lights1 green_toad_seg6_lights_06005908 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x06005920
ALIGNED8 static const Texture green_toad_seg6_texture_06005920[] = {
#include "green_toad/green_toad_face.rgba16.inc.c"
};

// 0x06006120
ALIGNED8 static const Texture green_toad_seg6_texture_06006120[] = {
#include "green_toad/green_toad_head.rgba16.inc.c"
};

// 0x06006920
static const Vtx green_toad_seg6_vertex_06006920[] = {
...
// 0x06006A10
static const Vtx green_toad_seg6_vertex_06006A10[] = {
...
// 0x06006B10
static const Vtx green_toad_seg6_vertex_06006B10[] = {
    {{{     0,   -143,      8}, 0, {  -546,    672}, {0xf8, 0x85, 0xe4, 0xff}}},
    {{{   -56,   -113,      7}, 0, {  -560,    370}, {0xab, 0xae, 0xd4, 0xff}}},
...
// 0x06006BD0
static const Vtx green_toad_seg6_vertex_06006BD0[] = {
...
// 0x06006CC0
static const Vtx green_toad_seg6_vertex_06006CC0[] = {
...
// 0x06006DC0
static const Vtx green_toad_seg6_vertex_06006DC0[] = {
    {{{  -141,     91,    -35}, 0, {   472,   1082}, {0xad, 0x52, 0xd1, 0xff}}},
...
// 0x06006EC0
static const Vtx green_toad_seg6_vertex_06006EC0[] = {
    {{{  -141,    -44,     37}, 0, {  -168,    914}, {0xba, 0xa7, 0x37, 0xff}}},
...
// 0x06006FB0
static const Vtx green_toad_seg6_vertex_06006FB0[] = {
...
// 0x060070B0
static const Vtx green_toad_seg6_vertex_060070B0[] = {
...
// 0x060071B0
static const Vtx green_toad_seg6_vertex_060071B0[] = {
...
// 0x06007200
static const Vtx green_toad_seg6_vertex_06007200[] = {
...
const Gfx green_toad_seg6_dl_06007300[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, green_toad_seg6_texture_06005920),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPLight(&green_toad_seg6_lights_06005908.l, 1),
    gsSPLight(&green_toad_seg6_lights_06005908.a, 2),
    gsSPVertex(green_toad_seg6_vertex_06006920, 15, 0),
    ...
    gsSPVertex(green_toad_seg6_vertex_06006A10, 16, 0),
    ...
    gsSPVertex(green_toad_seg6_vertex_06006B10, 12, 0),
...
const Gfx green_toad_seg6_dl_06007498[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, green_toad_seg6_texture_06006120),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPVertex(green_toad_seg6_vertex_06006BD0, 15, 0),
...
const Gfx green_toad_seg6_dl_060076C0[] = {
    gsSPVertex(green_toad_seg6_vertex_06007200, 16, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
...
const Gfx green_toad_seg6_dl_06007710[] = {
    gsDPPipeSync(),
    ...
    gsSPDisplayList(green_toad_seg6_dl_06007300),
    gsSPDisplayList(green_toad_seg6_dl_06007498),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_OFF),
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_SHADEFADEA, G_CC_SHADEFADEA),
    gsSPDisplayList(green_toad_seg6_dl_060076C0),
    gsDPPipeSync(),
    gsSPEndDisplayList(),
};
...
const Gfx green_toad_seg6_us_dl_06007788[] = {
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGBFADE, G_CC_MODULATERGBFADE),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
...
// 0x06007788
static const Lights1 green_toad_seg6_lights_06007788 = gdSPDefLights1(
    0x4C, 0x5A, 0x13,
    0x9A, 0xB5, 0x27, 0x28, 0x28, 0x28
);

// 0x060077A0
static const Vtx green_toad_seg6_vertex_060077A0[] = {
...
// 0x060078A0
static const Vtx green_toad_seg6_vertex_060078A0[] = {
...
const Gfx green_toad_seg6_dl_06007960[] = {
    gsSPLight(&green_toad_seg6_lights_06007788.l, 1),
    gsSPLight(&green_toad_seg6_lights_06007788.a, 2),
    gsSPVertex(green_toad_seg6_vertex_060077A0, 16, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    ...
    gsSPVertex(green_toad_seg6_vertex_060078A0, 12, 0),
...
const Gfx green_toad_seg6_dl_06007A48[] = {
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_SHADEFADEA, G_CC_SHADEFADEA),
    gsSPClearGeometryMode(G_CULL_BACK),
    gsSPDisplayList(green_toad_seg6_dl_06007960),
    gsDPPipeSync(),
...
const Gfx green_toad_seg6_us_dl_06007B00[] = {
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_SHADEFADEA, G_CC_SHADEFADEA),
    gsSPDisplayList(green_toad_seg6_dl_06007960),
    gsDPPipeSync(),
...
// 0x06007A80
static const Lights1 green_toad_seg6_lights_06007A80 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x06007A98
static const Lights1 green_toad_seg6_lights_06007A98 = gdSPDefLights1(
    0x7f, 0x6a, 0x50,
    0xfe, 0xd5, 0xa1, 0x28, 0x28, 0x28
);

// 0x06007AB0
static const Vtx green_toad_seg6_vertex_06007AB0[] = {
...
// 0x06007B90
static const Vtx green_toad_seg6_vertex_06007B90[] = {
...
// 0x06007C50
static const Vtx green_toad_seg6_vertex_06007C50[] = {
    {{{    29,      9,     49}, 0, {     0,      0}, {0x2b, 0x33, 0x6b, 0xff}}},
    {{{    57,      9,     22}, 0, {     0,      0}, {0x67, 0x41, 0x23, 0xff}}},
...
const Gfx green_toad_seg6_dl_06007D10[] = {
    gsSPLight(&green_toad_seg6_lights_06007A80.l, 1),
    gsSPLight(&green_toad_seg6_lights_06007A80.a, 2),
    gsSPVertex(green_toad_seg6_vertex_06007AB0, 14, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    ...
    gsSPVertex(green_toad_seg6_vertex_06007B90, 12, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    ...
    gsSPLight(&green_toad_seg6_lights_06007A98.l, 1),
    gsSPLight(&green_toad_seg6_lights_06007A98.a, 2),
    gsSPVertex(green_toad_seg6_vertex_06007C50, 12, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  2,  3,  0, 0x0),
...
const Gfx green_toad_seg6_dl_06007EB0[] = {
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_SHADEFADEA, G_CC_SHADEFADEA),
    gsSPDisplayList(green_toad_seg6_dl_06007D10),
    gsDPPipeSync(),
    gsSPEndDisplayList(),
};

// 0x06007ED8
static const Lights1 green_toad_seg6_lights_06007ED8 = gdSPDefLights1(
    0x7f, 0x6a, 0x50,
    0xfe, 0xd5, 0xa1, 0x28, 0x28, 0x28
);

// 0x06007EF0
static const Vtx green_toad_seg6_vertex_06007EF0[] = {
...
// 0x06007FF0
static const Vtx green_toad_seg6_vertex_06007FF0[] = {
    {{{     4,    -57,     18}, 0, {     0,      0}, {0x62, 0xd9, 0x45, 0xff}}},
    {{{   -17,    -43,     28}, 0, {     0,      0}, {0xcd, 0xf9, 0x73, 0xff}}},
...
const Gfx green_toad_seg6_dl_060080C0[] = {
    gsSPLight(&green_toad_seg6_lights_06007ED8.l, 1),
    gsSPLight(&green_toad_seg6_lights_06007ED8.a, 2),
    gsSPVertex(green_toad_seg6_vertex_06007EF0, 16, 0),
    ...
    gsSPVertex(green_toad_seg6_vertex_06007FF0, 13, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  3,  1, 0x0),
...
const Gfx green_toad_seg6_dl_060081F8[] = {
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_SHADEFADEA, G_CC_SHADEFADEA),
    gsSPDisplayList(green_toad_seg6_dl_060080C0),
    gsDPPipeSync(),
    gsSPEndDisplayList(),
};

// 0x06008220
static const Lights1 green_toad_seg6_lights_06008220 = gdSPDefLights1(
    0x7f, 0x6a, 0x50,
    0xfe, 0xd5, 0xa1, 0x28, 0x28, 0x28
);

// 0x06008238
static const Vtx green_toad_seg6_vertex_06008238[] = {
...
// 0x06008338
static const Vtx green_toad_seg6_vertex_06008338[] = {
...
const Gfx green_toad_seg6_dl_060083E8[] = {
    gsSPLight(&green_toad_seg6_lights_06008220.l, 1),
    gsSPLight(&green_toad_seg6_lights_06008220.a, 2),
    gsSPVertex(green_toad_seg6_vertex_06008238, 16, 0),
    ...
    gsSPVertex(green_toad_seg6_vertex_06008338, 11, 0),
...
const Gfx green_toad_seg6_dl_06008520[] = {
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_SHADEFADEA, G_CC_SHADEFADEA),
    gsSPDisplayList(green_toad_seg6_dl_060083E8),
    gsDPPipeSync(),
...
const Gfx green_toad_seg6_us_dl_06008608[] = {
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_SHADEFADEA, G_CC_SHADEFADEA),
    gsSPDisplayList(green_toad_seg6_dl_060083E8),
    gsDPPipeSync(),
...
// 0x06008560
static const Lights1 green_toad_seg6_lights_06008560 = gdSPDefLights1(
    0x34, 0x20, 0x0d,
    0x68, 0x40, 0x1b, 0x28, 0x28, 0x28
);

// 0x06008578
static const Vtx green_toad_seg6_vertex_06008578[] = {
...
// 0x06008678
static const Vtx green_toad_seg6_vertex_06008678[] = {
    {{{   -13,      7,     47}, 0, {     0,      0}, {0xda, 0x51, 0x59, 0xff}}},
    {{{    14,      7,     47}, 0, {     0,      0}, {0x34, 0x3b, 0x63, 0xff}}},
...
const Gfx green_toad_seg6_dl_06008748[] = {
    gsSPLight(&green_toad_seg6_lights_06008560.l, 1),
    gsSPLight(&green_toad_seg6_lights_06008560.a, 2),
    gsSPVertex(green_toad_seg6_vertex_06008578, 16, 0),
    ...
    gsSPVertex(green_toad_seg6_vertex_06008678, 13, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
...
const Gfx green_toad_seg6_dl_06008890[] = {
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_SHADEFADEA, G_CC_SHADEFADEA),
    gsSPDisplayList(green_toad_seg6_dl_06008748),
    gsDPPipeSync(),
    gsSPEndDisplayList(),
};

// 0x060088B8
static const Lights1 green_toad_seg6_lights_060088B8 = gdSPDefLights1(
    0x34, 0x20, 0x0d,
    0x68, 0x40, 0x1b, 0x28, 0x28, 0x28
);

// 0x060088D0
static const Vtx green_toad_seg6_vertex_060088D0[] = {
...
// 0x060089D0
static const Vtx green_toad_seg6_vertex_060089D0[] = {
...
const Gfx green_toad_seg6_dl_06008A90[] = {
    gsSPLight(&green_toad_seg6_lights_060088B8.l, 1),
    gsSPLight(&green_toad_seg6_lights_060088B8.a, 2),
    gsSPVertex(green_toad_seg6_vertex_060088D0, 16, 0),
    ...
    gsSPVertex(green_toad_seg6_vertex_060089D0, 12, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
...
const Gfx green_toad_seg6_dl_06008BD8[] = {
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_SHADEFADEA, G_CC_SHADEFADEA),
    gsSPDisplayList(green_toad_seg6_dl_06008A90),
    gsDPPipeSync(),
    gsSPEndDisplayList(),
};
